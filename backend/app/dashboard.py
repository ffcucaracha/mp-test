...
def jury_dashboard(db: Session = Depends(get_db)) -> HTMLResponse:
    ...
    html = f"""<!doctype html><html lang='ru'><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1'><title>AgroConnect — дашборд</title><style>
